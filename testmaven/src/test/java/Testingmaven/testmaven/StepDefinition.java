...
public class StepDefinition {
	...
	public void click_on_next_button_and_enter_vehcile_registration_code_and_submit() throws Throwable {
		...
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("DY03 HYM");
	...
	public void validate_vechile_details() {
		Assert.assertTrue("color is not displayed", driver.findElement(By.xpath("//strong[text()='BLACK']")).isDisplayed());
